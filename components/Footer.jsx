    ...
    return (
        <div className='max-w-[1320px] mx-auto mt-20 '>
            <footer className="footer ">
                <nav>
                    <a className="font-bold text-2xl"><span>Hi</span><span className="text-[#30AF5B]">link.</span></a>
                </nav>
                <nav>
                    <h6 className="footer-title text-black">Learn More</h6>
                ...
                <nav>
                    <h6 className="footer-title text-black">Our Community</h6>
                    <a className="link link-hover">Branding</a>
                    <a className="link link-hover">Design</a>
                    <a className="link link-hover">Marketing</a>
                </nav>
