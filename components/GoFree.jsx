            ...
            <div className='flex flex-col lg:flex-row space-x-20'>
                <div className='p-20 '>
                    ...
                    <div className='my-10 flex space-x-5 '>
                        <button className="btn md:btn-wide btn-lg space-x-4 rounded-full text-[#30AF5B]">
                            <Image src='/apple.svg' height={30} width={30} alt='Apple' className=''></Image>
                            App Store
                        </button>
                        <button className="btn md:btn-wide btn-lg space-x-4 rounded-full bg-[#292D27] text-white">
                            <Image src='/android.svg' height={30} width={30} alt='Apple' className=''></Image>
                            App Store
                        </button>
                    </div>
                </div>
                {/* <div className='relative -top-44 border-2 border-red-500 overflow-hidden'>
                <Image src='/phones.png' height={800} width={500} alt='Apple' className='object-cover'></Image>
                </div> */}
                <div className='relative  overflow-hidden md:h-[550px] flex items-center justify-center'>
